...
class RotaryIRQ(Rotary):
    ...
    def _sw_callback(self, pin):
        ...
        self._swDebounceTimer.init(mode=Timer.PERIODIC, period=10, callback=self._re_enable_sw_irq)
...
class RotarySWTest(object):
    ...
    def sw_down(self):
        print(f"PJA: 
    def sw_up(self):
        print(f"SW released. Down for {self._rotaryIRQ.getSWDownSec()} seconds.")
