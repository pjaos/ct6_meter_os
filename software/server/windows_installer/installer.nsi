...
SetCompressor lzma
InstallDir "$LocalAppData\Programs\CT6"
...
[% endif %]
# We don't want the user to install for everyone as they need
# write access to the install folder so that pipenv can run
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  nsExec::ExecToLog '"$INSTDIR\post_install.bat"'
